export default function Projects({ t }) {
  return (
    <section id="projects" data-reveal className="relative mx-auto max-w-6xl px-4 py-16">
      ...
      <div className="mt-8 grid sm:grid-cols-2 gap-6">
        {t.projects.list.map((p, idx) => (
          <a
            ...
            className="block rounded-xl border border-slate-800 bg-slate-900/40 p-5 hover:bg-slate-900/60 transition-colors"
          >
